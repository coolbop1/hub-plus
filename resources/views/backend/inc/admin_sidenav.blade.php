        ...
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                    ...
                    {{-- http://localhost:8888/hub-plus/public/uploads/all/S15XCVjZEwrADouxUIO0Y3qXMmUKGmzjGRY00y9w.png --}}
                    <img class="mw-100" src="{{ static_asset('/uploads/all/S15XCVjZEwrADouxUIO0Y3qXMmUKGmzjGRY00y9w.png') }}" class="brand-icon" alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
